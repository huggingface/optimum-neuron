...
@pytest.fixture
async def vllm_docker_service_from_local_neuron_model(vllm_docker_launcher, base_neuron_llm_config):
...
@pytest.fixture
async def vllm_docker_service_from_hub_neuron_model(vllm_docker_launcher, base_neuron_llm_config):
...
@pytest.fixture
async def vllm_docker_service_from_hub_model(vllm_docker_launcher, base_neuron_llm_config):
...
async def _test_vllm_docker_service_base(vllm_service, prompt, max_output_tokens):
...
async def test_vllm_docker_service_from_local_neuron_model(
    vllm_docker_service_from_local_neuron_model, prompt, max_output_tokens
):
    await _test_vllm_docker_service_base(vllm_docker_service_from_local_neuron_model, prompt, max_output_tokens)
...
async def test_vllm_docker_service_from_hub_neuron_model(
    vllm_docker_service_from_hub_neuron_model, prompt, max_output_tokens
):
    await _test_vllm_docker_service_base(vllm_docker_service_from_hub_neuron_model, prompt, max_output_tokens)
...
async def test_vllm_docker_service_from_hub_model(vllm_docker_service_from_hub_model, prompt, max_output_tokens):
    await _test_vllm_docker_service_base(vllm_docker_service_from_hub_model, prompt, max_output_tokens)


@pytest.mark.asyncio
async def test_vllm_docker_service_sampling_parameters(vllm_docker_service_from_local_neuron_model):
    ...
    greedy_tokens_with_stop, greedy_text_with_stop = await vllm_docker_service_from_local_neuron_model.client.greedy(
