...
CONFIGS = [
    AttentionTestConfig(name="gpt-oss", config_id="tengomucho/tiny-random-gpt-oss", attention_cls=GptOssAttention, rotary_embedding_cls=GptOssRotaryEmbedding, neuron_attention_cls=NeuronGptOssAttention),
    AttentionTestConfig(name="mixtral", config_id="dacorvo/Mixtral-tiny", attention_cls=MixtralAttention, rotary_embedding_cls=MixtralRotaryEmbedding, neuron_attention_cls=NeuronMixtralAttention),
]
...
def test_gpt_oss_attention_prefill(test_config: AttentionTestConfig):
