...
## Get the optimum-neuron vLLM image

Checkout the [optimum-neuron vLLM image branch](https://github.com/dacorvo/llm-hosting-container/tree/vllm_optimum_neuron_dlc).

Build the image:

```shell
$ docker build --rm \
    -f ./huggingface/pytorch/vllm-optimum-neuron/0.3.0/Dockerfile \
    -t vllm-optimum-neuron:0.3.0 .
```
