...
5. You case you find that some commands seem greyed out in the menus, but the keyboard commands will still work (⌘S to save or ^⇧` for terminal), you may need to restart VS Code.