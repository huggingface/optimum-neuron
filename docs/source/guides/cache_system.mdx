...
- 2nd approach: record one graph, compile it with the neuronx-cc compiler to a NEFF binary file, and serialize as a TorchScript module (eg. inference of encoders, stable diffusion and seq2seq models).
