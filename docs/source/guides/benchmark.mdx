...
`!docker pull ghcr.io/huggingface/optimum-neuron-vllm:latest`
...
--device=/dev/neuron11 \
-ti \
--entrypoint "optimum-cli" ghcr.io/huggingface/optimum-neuron-vllm:latest \
...
In this blog post, I took you through how to compile and load an Optimum Neuron model, how to serve it with the Optimum Neuron vLLM container, and how to benchmark your settings to optimize for your workload.

## References

https://huggingface.co/docs/optimum-neuron/en/guides/cache_system
https://github.com/huggingface/optimum-neuron/tree/main/benchmark/vllm
