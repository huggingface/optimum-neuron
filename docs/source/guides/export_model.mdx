...
<pre><code class="language-mermaid">graph compilation;
...
In the last section, you can see the input shape options to pass for exporting static neuron model. Default values below will be used if mandatory shape information is not defined:
