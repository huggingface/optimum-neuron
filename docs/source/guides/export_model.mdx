...
You can see examples of these parameters in the .env and docker-compose.yaml files in the [TGI benchmark examples](https://github.com/huggingface/optimum-neuron/tree/main/benchmark/text-generation-inference/performance). 
