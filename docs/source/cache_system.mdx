...
As you might have noticed while training your models on Trainium instances, Neuron cores work on models compiled to the `neff` format. 
It means that training requires one or multiple compilation step(s) that can take a long time. 
...
<p align="center">
  <img alt="Cache system flow" src="https://huggingface.co/datasets/optimum/documentation-images/resolve/main/neuron/cache_system_flow.jpg" width="450">
  <br>
