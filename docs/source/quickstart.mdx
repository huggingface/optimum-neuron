...
🤗 Optimum Neuron makes AWS accelerator adoption seamless for Transformers users with **drop-in replacements** for standard training and inference components.

> **🚀 Need to set up your environment first?** Check out our [Getting Started](getting-started) guide for complete installation and AWS setup instructions.
...
- 🚀 **[Distributed Training](guides/distributed_training)** - Scale across multiple accelerators
