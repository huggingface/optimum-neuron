...
The list of officially validated models and tasks is available [here](https://huggingface.co/docs/optimum-neuron/package_reference/supported-architectures).
