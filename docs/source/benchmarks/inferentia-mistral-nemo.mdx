...
# Mistral-Nemo-Instruct performance on AWS Inferentia2 (Latency & Througput)
...
|------------------|------------|-----------------|
| Mistral-Nemo BS1 | 1          | 4096            |
| Mistral-Nemo BS4 | 4          | 4096            |
...
![Mistral Nemo inferentia2 TTFT](https://raw.githubusercontent.com/huggingface/optimum-neuron/main/docs/assets/benchmarks/inferentia-mistral-nemo/ttft.png "Time to first token")
...
![Mistral Nemo inferentia2 inter-token latency](https://raw.githubusercontent.com/huggingface/optimum-neuron/main/docs/assets/benchmarks/inferentia-mistral-nemo/latency.png "Inter-token latency")
...
![Mistral Nemo inferentia2 throughput](https://raw.githubusercontent.com/huggingface/optimum-neuron/main/docs/assets/benchmarks/inferentia-mistral-nemo/throughput.png "Throughput")
