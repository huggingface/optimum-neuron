...
|-----------------------------|-----------------|---------------------------------------------|
| Training  | 0.0.13           | 763104351884.dkr.ecr.region.amazonaws.com/tensorflow-optimum-neuron:2.4.1   |
| Inference      | 0.0.18           | 763104351884.dkr.ecr.region.amazonaws.com/pytorch-optimum-neuron:1.8.1      |
