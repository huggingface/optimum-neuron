...
To create your instance, follow the guide [here](https://huggingface.co/docs/optimum-neuron/guides/setup_aws_instance).
...
📝 **Complete script available:** All steps above are combined in a ready-to-use script [here](https://github.com/huggingface/optimum-neuron/blob/main/examples/training/qwen3/finetune_qwen3.py).
...
🔧 **Single command execution:** The complete training script is available [here](https://github.com/huggingface/optimum-neuron/blob/main/examples/training/qwen3/finetune_qwen3.sh):
