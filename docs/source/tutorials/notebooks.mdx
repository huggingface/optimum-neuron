...
| [Deploy Mistral on a SageMaker endpoint with Inferentia and HF TGI](https://github.com/huggingface/optimum-neuron/blob/main/notebooks/text-generation/mistral-inference-tgi-sagemaker.ipynb)       | Show how to run Mistral on [AWS Inferentia 2](https://aws.amazon.com/machine-learning/inferentia/) in a [SageMaker endpoint](https://docs.aws.amazon.com/sagemaker/latest/dg/whatis.html) with [HF TGI](https://github.com/huggingface/text-generation-inference).                                                                                      | [![Open in AWS Studio](https://studiolab.sagemaker.aws/studiolab.svg)](https://studiolab.sagemaker.aws/import/github/huggingface/optimum-neuron/blob/main/notebooks/text-generation/mistral-inference-tgi-sagemaker.ipynb)        |