...
Stable Diffusion XL (SDXL) is a a latent diffusion model for text-to-image. Compared the previous versions of Stable Diffusion models,it improves the quality of generated images with a times larger UNet.
