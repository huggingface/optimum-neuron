...
If you have an existing infrastructure or prefer to install Optimum Neuron manually, you can use pip installation. Note that you will need to ensure the Neuron drivers and tools are properly installed first.
