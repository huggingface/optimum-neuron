...
| CLIP                      | feature-extraction, image-classification, zero-shot-image-classification                                                                      |
...
| DeBERTa (INF2 only)       | feature-extraction, fill-mask, question-answering, text-classification, token-classification                                                  |
| DeBERTa-v2 (INF2 only)    | feature-extraction, fill-mask, question-answering, text-classification, token-classification                                                  |
...
| CLIP                          | feature-extraction, sentence-similarity                                                                                                |


<Tip>

 To learn how to export a model for inference, you can check this [guide](https://huggingface.co/docs/optimum-neuron/guides/export_model).
