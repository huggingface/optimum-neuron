...
from .import_utils import is_neuronx_distributed_available
    ...
    def new_fwd(*args, **kwargs):
        ...
        if "input_ids" in kwargs:
            ...
            if (
                ...
                and kwargs.get("use_cache", False) is False
        ...
        outputs["logits"] = outputs["logits"][:, :cur_len, ...].to(torch.float32)
