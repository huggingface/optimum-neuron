...
For a comprehensive walkthrough of the class hierarchy, graph variants, forward dispatch,
and generation loop with ASCII diagrams, see [ARCHITECTURE_CAUSAL_LM.md](ARCHITECTURE_CAUSAL_LM.md).
