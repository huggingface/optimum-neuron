...
from .cache.hub_cache import ModelCacheEntry, hub_neuronx_cache
...
class NeuronDecoderModel(NeuronModel):
    ...
    def __init__(
        ...
        cache_entry = None if checkpoint_id is None else ModelCacheEntry.create(checkpoint_id, config)
